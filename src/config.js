const config = {
  ...
  // 颜色配置
  color: {
    themecolor: "#F9FAFB", // 主题颜色，推荐趋于亮白可带有轻微色调，例： #D1FFEC
    welcometitlecolor: "#FF9AA2", // 标题颜色 例： #7BFFC9
  },
  ...
  background: {
    "pc":{   //pc端
      ...
      "datainfo":{
        "title":"冰川", 
        "preview":"/img/wallpaper/static/冰川/image-pre.webp",
        "url":"/img/wallpaper/static/冰川/image.png",     //当然，也可填写网络地址或壁纸api，如随机PC壁纸api："url":"https://t.mwm.moe/pc"
      },
    },
    "mobile":{   //移动端
      "type":"pic",
  ...
  "你看到这行字时，风刚好经过我的心头。",
  "我循着光的方向靠近，却不是你梦中那道光。",
  "心若干净，风也柔软；人若自由，哪怕漂泊也是归途。",
  "别让短暂的遗憾，遮住漫天星光。路还长，请你带笑而行。"
],
  ...
  projectcards:[ 
    ...
    {go:"📝 前往",img:"/img/Alist/AlistDeploy.jpg",title:"Alist本地部署（Windows）",subtitle:"3,000 miles of wonder", text:"If you see this line, I've managed to get your attention.",url:"/pages/AlistDeploy.html",show:false},
    ...
    // {go:"💍 前往",img:"/img/sunshine.jpg",title:"Project 7",subtitle:"7,000 miles of wonder", text:"If you see this line, I've managed to get your attention.",url:"xiaozhangya.vercel.app",show:false},
    // {go:"🔍 前往",img:"/img/sunshine.jpg",title:"Project 8",subtitle:"8,000 miles of wonder", text:"If you see this line, I've managed to get your attention.",url:"xiaozhangya.vercel.app",show:false},
  ],
